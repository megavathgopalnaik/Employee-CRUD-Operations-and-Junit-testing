...
public class ExceptionControllerAdvice {
	  ...
	  @Autowired
	    ...
	    public ResponseEntity<ErrorInfo> SchedulerExceptionHandler(EmployeeException exception)
	    {
	   //will print error in console 	
		LOGGER.error(exception.getMessage(), exception);
		ErrorInfo errorInfo = new ErrorInfo();
		errorInfo.setErrorCode(HttpStatus.BAD_REQUEST.value());
	//	the below line will fetch the messages from environment variables 
	//	which can also be added in application.properties files
